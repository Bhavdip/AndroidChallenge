...
package com.skillvo.android.model;
...
public class ShortProvider implements Parcelable {
    ...
    protected ShortProvider(Parcel in) {
    ...
    public static final Parcelable.Creator<ShortProvider> CREATOR = new Parcelable.Creator<ShortProvider>() {
        @Override
        public ShortProvider createFromParcel(Parcel source) {
            return new ShortProvider(source);
        }

        @Override
        public ShortProvider[] newArray(int size) {
            return new ShortProvider[size];
        }
    };
}
